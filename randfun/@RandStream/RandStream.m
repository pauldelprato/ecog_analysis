...
%   Copyright 2008-2012 The MathWorks, Inc. 
    ...
    methods % subsref is overloaded, but need these so that struct will work
        ...
        function b = get.NormalTransform(a), b = getset_mex('randnalg',a.StreamID);      end
    ...
    properties(Constant=true, GetAccess='protected')
        ...
        BuiltinTypes = ...
             {'mcg16807' 'mlfg6331_64'   'mrg32k3a'      'mt19937ar' 'shr3cong' 'swb2712'  };
        CompatNames = ...
             {'v4'       'multFibonacci' 'combRecursive' 'twister'   'v5normal' 'v5uniform'};
        BuiltinDescrs = ...
             {'MATLAB:RandStream:list:mcg16807Description' 'MATLAB:RandStream:list:mlfg6331_64Description' ...
...
%            RANDSTREAM/RAND, RANDSTREAM/RANDI, RANDSTREAM/RANDN.
    ...
    methods(Static=true, Access='protected')
        function globe = createGlobalStream()
            ...
            [globe.StreamID,globe.Type,globe.Seed] = getset_mex('defaultstream');
